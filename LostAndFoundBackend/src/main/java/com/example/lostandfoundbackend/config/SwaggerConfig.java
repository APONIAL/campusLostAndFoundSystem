package com.example.lostandfoundbackend.config;
...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)  // DocumentationType.SWAGGER_2 固定的，代表swagger2
                ...
                // 扫描指定包下的接口，最为常用
                .apis(RequestHandlerSelectors.basePackage("com.example.lostandfoundbackend.controller"))
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfoBuilder()
                ...
                .description("校园失物招领项目Swagger管理") // 可以用来描述整体的API
                //.termsOfServiceUrl("https://www.baidu.com") // 用于定义服务的域名（跳转链接）
                .version("2.0") // 可以用来定义版本
